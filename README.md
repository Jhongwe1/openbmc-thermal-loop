...
回覆 → 2026-08-31 維護者與另一位 reviewer +1 → 2026-09-02 CLA 核准、
CI 通過(PS2)→ 2026-09-04 維護者撤掉 CLA 期間的 −1,待 +2 合併)、
[93470](https://gerrit.openbmc.org/c/openbmc/phosphor-pid-control/+/93470)
(configure.md 補七個未文件化欄位,2026-09-02 CI 通過,待首輪人工審查)——
...
- [ ] Gate 6　Upstream　← **兩筆 change 已上 Gerrit(2026-08-13):**
  ...
  - [x] **ICLA 核准、CI 通過(2026-09-02)→ owner 撤 −1(2026-09-04)**:帳號進
        CI 白名單;93470 首跑 Verified +1;93469 首跑因 commit message 英式拼字
        被擋 → PS2 只改一字 → Verified +1;owner 9/4 撤掉複製到 PS2 的 CLA −1,
        表示 release maintainer 在 change 上確認即合併 ← [`docs/upstream.md`](docs/upstream.md)
  - [ ] 剩:owner +2 → 合併(9/5 已回覆,並指出 ICLA 已在其所指的 CLA 資料夾)
...
完整紀錄在 [`LOG.md`](LOG.md)(99 則,截至 2026-09-05;計數的權威是
`grep -c '^## ' LOG.md`,不是這行字),每則都照
