...
## 2026-09-01(W14)CLA:私下信箱等 27 天,公開 thread 六小時就有 maintainer 接手

**現象** 8/31 15:55Z —— 距我在 93469 的公開回覆(09:38Z)6 小時 17 分 ——
release maintainer Andrew Geissler(docs change 93905 的 owner)直接留言:
ICLA 的受理正在收緊(見 93905),讀完後若仍認為自己符合資格,可把 ICLA
直寄他本人信箱審核,並「盡可能附上個人背景與現職資訊,我需要能查證你的
方式」。同一件事在 `manager@lfprojects.org` 那條私下通道已 27 天無回音。

**判斷** 讀 93905 全文(`CONTRIBUTING.md` 的 diff):收緊的是 **CCLA** ——
受僱於晶片/韌體/伺服器廠、CSP、或任何可能對專案主張 IP 的公司者,一律要
雇主簽;**ICLA 保留給不屬於這些類別的個人**。動機寫得很白:防止公司事後
宣稱員工未經授權貢獻了專有 IP。所以資格自問只有一句:「我**現在**受僱於
上列任何類別的公司嗎?」—— 否,ICLA 適用。

**處理(2026-09-01,台北)** 寄出:① 8/4 簽的**原件** PDF(不重簽 ——
兩份日期不同的文件添亂,且 8/4 時間戳自證已照原流程等了 28 天);② 寄件人
用與 Gerrit/GitHub/ICLA 相同的 Gmail,CC 學校信箱(第三方核發的地址);
③ 可查證管道:GitHub、Gerrit 兩筆 change、本 repo;④ 主動聲明:若未來
受僱於 93905 所列類別的公司,屆時貢獻改走該雇主的 CCLA(直接回應 93905
的立法動機)。寄後在 93469 回覆確認(18:25Z,messages=14,REST 查證)。
LF 線(原定 9/4 CC 第二封)擱置;下次追蹤點 **2026-09-08** ——
`CONTRIBUTING.md` 自己寫合理等待是 "on the order of a week",
不照三天一催的焦慮節奏。

**教訓** 與 8/31「沒放在每天會看的地方的 timer 不是 timer」成對:
**請求也要放在對的人會看的地方**。同一份 ICLA,私下信箱 27 天沒有任何
回音;把狀態一五一十寫在公開 change 上,6 小時就有 TSC 成員接手 ——
